...
void main() {
  runApp(
    ChangeNotifierProvider(
      create: (context) =>
          ProductProvider(), // Forneça uma instância de ProductProvider
      child: const MyApp(),
    ),
  );
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Teste técnico Malwee by GuiMeiring',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Teste técnico Malwee by GuiMeiring'),
    );
  }
}
