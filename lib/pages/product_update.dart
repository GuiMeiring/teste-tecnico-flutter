...
class ProductUpdate extends StatelessWidget {
  ProductUpdate({super.key, required this.id});
  ...
  Widget build(BuildContext context) {
    ...
    void _productById() {
      var product = provider.produtoById(id);
      _name.text = product.nome;
      _preco.text = product.preco.toString();
      _material.text = product.material;
      _url.text = product.url;
    }
              ...
              child: IconButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      provider.updateProduct(provider.fromMap(
                          id,
                          _name.text,
